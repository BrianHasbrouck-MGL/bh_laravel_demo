        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/" class=" <?= urlIs('/') ? 'bg-gray-900 text-white' : 'text-gray-300'; ?>  hover:bg-gray-700 hover:text-white bg-gray-700 px-3 py-2 rounded-md text-sm font-medium text-gray-300">Home</a>
              <a href="/about" class=" <?= urlIs('/about') ? 'bg-gray-900 text-white' : 'text-gray-300'; ?>  hover:bg-gray-700 hover:text-white bg-gray-700 px-3 py-2 rounded-md text-sm font-medium text-gray-300">About</a>
              <a href="/contact" class=" <?= urlIs('/contact') ? 'bg-gray-900 text-white' : 'text-gray-300'; ?>  hover:bg-gray-700 hover:text-white bg-gray-700 px-3 py-2 rounded-md text-sm font-medium text-gray-300">Contact Us</a>
            </div> 
          </div>
        </div>
        <div class="hidden md:block">
